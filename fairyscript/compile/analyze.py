...
class AnalysisCompiler(object):
	...
	def set_options(self, options):
		...
		self._show_source_info = not options.no_source_info
	...
	def compile_script(self, script):
		...
		intro = "(generated by fairyc v" + get_fairyc_version() + ")"
		self.add_line(intro)
		self.add_line("=" * len(intro))
		self.add_line()
	...
	def _make_ref_info(self, node):
		...
		try:
			...
			_log.warning("Problem while reading lineno from " + node_type + "; excluding from output")
