...
class Document(ElementProxy):
    ...
    def add_heading(self, text='', level=1, bookmark_name=None):
        """
        ...
        *level*. If *level* is 0, the style is set to `Title`. If *level* is
        ...
        bm = None
        return self.add_paragraph(text, style, bookmark_name)
    ...
    def add_paragraph(self, text='', style=None, bookmark=None):
        """
        ...
        break.
        """
        return self._body.add_paragraph(text, style, bookmark)
